  ...
  return (
    <div className="flex h-screen overflow-hidden relative">
      ...
      {isDraggingExtFile && !isExpired && !canBoardEdit && (
        <div className="fixed inset-0 bg-black/50 z-50 flex flex-col gap-1 items-center justify-center text-off-white ">
      ...
      >
        ...
        <main className="flex-1 z-0">
          <div
            ...
            transition-opacity  duration-200 text-off-white text-3xl bg-primary px-6 py-3 rounded-xl shadow-xl 
