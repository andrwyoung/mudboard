...
const essentialItems: TutorialRowType[] = [
  ...
  { text: "Grab an Image from the Greenhouse", mission: "greenhouse" },
  { text: "Create a Mudkit", mission: "mudkit" },
];
...
const extraItems: TutorialRowType[] = [
  {
    text: (
      <div className="flex flex-col">
        ...
        <span className="text-xs">(Try Pinterest)</span>
      </div>
    ),
    mission: "upload",
  },
  { text: "Spotlight an Image", mission: "spotlight" },
  { text: "Export a Section", mission: "export" },
];
    ...
    <div className="flex items-start justify-between gap-2">
      ...
      <button
        ...
        onClick={() => {
          ...
          console.log("Show help for:", item.mission);
        }}
      >
        Tips
      </button>
...
export default function TutorialPanel() {
  ...
  return (
    <div
      ...
      w-64 bg-background shadow-lg z-60 rounded-sm overflow-hidden"
    >
      <div
