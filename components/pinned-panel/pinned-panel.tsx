...
export default function PinnedPanel() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-overlay-background text-off-white overflow-auto relative">
      <div className="top-4 left-4 flex flex-row gap-2 items-center absolute z-100">
        <h1 className="text-sm text-off-white font-header translate-y-[1px] font-semibold">
          Spotlight View
        </h1>
        <InfoTooltip
