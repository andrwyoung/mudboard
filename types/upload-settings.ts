...
export const LARGE_IMAGE_WIDTH = 1200;
export const COMPRESSED_IMAGE_WIDTH = 800;
export const COMPRESSED_THUMB_WIDTH = 300;
export const DEFAULT_FILE_EXT = "webp";
export const DEFAULT_FILE_MIME = "image/webp";

export type ImageSizes = "thumb" | "medium" | "large" | "full";
export type ThumbnailNames =
  | "board-thumb-ext"
  | "board-thumb-dashboard"
  | "section-thumb-ext";

export const IMAGE_VARIANT_MAP: Record<
  ImageSizes,
  { width: number; quality: number }
> = {
  thumb: { width: COMPRESSED_THUMB_WIDTH, quality: 0.5 },
  medium: { width: COMPRESSED_IMAGE_WIDTH, quality: 0.6 },
  large: { width: LARGE_IMAGE_WIDTH, quality: 0.75 },
  full: { width: MAX_IMAGE_WIDTH, quality: 0.85 },
};
...
// cropping
export const THUMBNAIL_ASPECT_MAP: Record<
  ThumbnailNames,
